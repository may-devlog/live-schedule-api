...
import {
  ...
  IconMail,
  IconX,
} from "@/components/FeatherSvgIcons";
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            >
              <View style={styles.menuButtonContent}>
                <IconLogOut size={18} color="#d93025" />
