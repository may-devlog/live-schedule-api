...
export default function GuideScreen() {
  return <StaticInfoPage title="GenBGTの使い方" lead="ライブの予定はもちろん、当日の移動や宿泊、費用まで、まとめてひとつの場所で管理できます。" sections={[
    ...
    },
    {
      ...
      images: [
        { source: require('@/assets/images/guide/schedule-traffic-stay.png'), caption: '交通・宿泊情報を紐づけると遠征費合計が自動で計算されます', aspectRatio: 16 / 9 },
      ],
    },
    {
      ...
      images: [
        { source: require('@/assets/images/guide/related-schedule-picker.png'), caption: '関連スケジュールの選択画面。同一遠征の予定をまとめて紐づけられます', aspectRatio: 16 / 9 },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        { source: require('@/assets/images/guide/notification-settings.png'), caption: '通知設定画面', aspectRatio: 16 / 9 },
      ],
    },
    {
