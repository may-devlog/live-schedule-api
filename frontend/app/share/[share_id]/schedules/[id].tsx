...
const styles = StyleSheet.create({
  ...
  weekdayText: { color: brand.violet, fontWeight: "400", fontFamily: Platform.OS === "web" ? "SFMono-Regular, Menlo, Consolas, monospace" : "monospace" },
  ...
  stayColumnDesktop: { order: 3, flexGrow: 0, flexBasis: "66%", marginTop: -92 },
  sectionTitle: {
    fontSize: 14,
    fontWeight: "700",
    color: "#37352f",
  ...
  relationTime: { fontSize: 13, lineHeight: 20, color: brand.muted, fontVariant: ["tabular-nums"], fontFamily: Platform.OS === "web" ? "SFMono-Regular, Menlo, Consolas, monospace" : "monospace" },
  relationTitle: {
    flex: 1,
    fontSize: 13,
    lineHeight: 20,
