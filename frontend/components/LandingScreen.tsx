...
const getStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  heroActions: { flexDirection: 'row', alignItems: 'center', gap: 14, marginTop: 32 },
  heroActionsNarrow: { flexDirection: 'column', width: '100%' },
  ...
  textButton: { minHeight: 48, paddingHorizontal: 10, alignItems: 'center', justifyContent: 'center' },
  ...
  featureCardNarrow: { flexBasis: '100%' },
