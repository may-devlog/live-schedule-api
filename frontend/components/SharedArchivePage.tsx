...
const getStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  title: { color: colors.accent, fontSize: 48, lineHeight: 56, fontWeight: "800", letterSpacing: -1.2 },
  ...
  archiveTab: { flex: 1, minHeight: 44, alignItems: "center", justifyContent: "center", backgroundColor: colors.surface },
  // DarkモードではaccentDeep（常にほぼ黒）だと沈んだ背景に埋もれてしまうため、
  // 常にコントラストの立つaccent＋accentContrastTextを使う
  archiveTabActive: { backgroundColor: colors.accent },
  archiveTabText: { color: colors.muted, fontSize: 14, fontWeight: "500" },
  archiveTabTextActive: { color: colors.accentContrastText, fontWeight: "700" },
  ...
  yearMenu: { position: "absolute", top: 46, left: 0, minWidth: 110, borderRadius: 10, backgroundColor: colors.surface, padding: 5, ...shadow },
  ...
  groupingButtonActive: { backgroundColor: colors.accent, borderColor: colors.accent },
  groupingButtonText: { color: colors.ink, fontSize: 13, fontWeight: "400" },
  groupingButtonTextActive: { color: colors.accentContrastText, fontWeight: "600" },
  // メイン/サブで自身・お目当て⇄出演者と重複するため選べない選択肢。トップページARCHIVEの非当年チップと同系色でグレーアウト
  groupingButtonDisabled: { backgroundColor: colors.surfaceAlt, borderColor: colors.surfaceAlt },
  ...
  monthTitle: { color: colors.accent, fontSize: 25, lineHeight: 32, fontWeight: "800", marginBottom: 10 },
  ...
  subGroupHeader: { paddingLeft: 32, minHeight: 48, backgroundColor: colors.surfaceAlt },
  ...
  subGroupTotal: { paddingLeft: 58, backgroundColor: colors.surfaceAlt },
  ...
  dateText: { color: colors.accent, fontSize: 29, lineHeight: 35, fontWeight: "800", fontVariant: ["tabular-nums"] },
  ...
  breakfastBadge: { alignSelf: "flex-start", backgroundColor: colors.accentSoft, borderRadius: 5, paddingHorizontal: 10, paddingVertical: 4 },
  breakfastBadgeOff: { backgroundColor: colors.surfaceAlt },
